...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $sql = "DELETE FROM danhmuckhenthuong_kyluat WHERE id = $id";
    if ($conn->query($sql) === TRUE) {
        echo "<script>alert('Danh mục đã được xóa.'); window.location.href='quanly_dmktkl.php';</script>";
    } else {
        echo "Lỗi: " . $conn->error;
    }
}

$sql = "SELECT * FROM danhmuckhenthuong_kyluat";
...
<head>
    ...
    <title>Quản lý Danh Mục Khen Thưởng Kỷ Luật</title>
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="them_danh_muc.php" class="btn btn-primary mb-3"><i
                                class="bi bi-plus-circle me-1"></i>Thêm Danh Mục</a>
                                            ...
                                            echo "<tr>
                                                    ...
                                                    <td>
                                                        <div class='btn-group' role='group'>
                                                            <a href='sua_danh_muc.php?id={$row['id']}' class='btn btn-warning btn-sm'><i class='bi bi-pencil'></i></a>
