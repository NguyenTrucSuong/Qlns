...
$sql = "SELECT * FROM loaihinhdaotao";
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="them_lhdt.php" class="btn btn-primary mb-3"><i class="bi bi-plus-circle me-1"></i>Thêm
                            Loại Hình Đào Tạo</a>
                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            echo "<tr>
                                                    <td>{$row['id']}</td>
                                                    <td>{$row['ten_loai_hinh_daotao']}</td>
                                                    <td>
                                                        <div class='btn-group' role='group'>
                                                            <a href='sua_lhdt.php?id={$row['id']}' class='btn btn-warning btn-sm'><i class='bi bi-pencil'></i></a>
                                                            <a href='xoa_lhdt.php?id={$row['id']}' class='btn btn-danger btn-sm' onclick='return confirm(\"Bạn có chắc chắn muốn xóa?\")'><i class='bi bi-trash'></i></a>
                                                        </div>
                                                    </td>
                                                </tr>";
                                        }
