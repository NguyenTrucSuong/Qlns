        ...
        <div class="row mt-4">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="them_bangcap.php" class="btn btn-primary mb-3"><i
                                class="bi bi-plus-circle me-1"></i>Thêm Bằng Cấp</a>
                                            ...
                                            echo "<tr>
                                                    ...
                                                    <td>
                                                        <div class='btn-group' role='group'>
                                                            <a href='sua_bangcap.php?id={$row['id']}' class='btn btn-warning btn-sm'><i class='bi bi-pencil'></i></a>
                                                            <a href='xoa_bangcap.php?id={$row['id']}' class='btn btn-danger btn-sm' onclick='return confirm(\"Bạn có chắc chắn muốn xóa?\")'><i class='bi bi-trash'></i></a>
                                                        </div>
                                                    </td>
                                                </tr>";
                                        }
